...
- Interfere com [docs/specs/done/23-rollout-de-auditoria-operacional-no-projeto.md](../done/23-rollout-de-auditoria-operacional-no-projeto.md): a adoção da auditoria no contexto de durabilidade/replay do worker será implementada exclusivamente na Spec 23.
