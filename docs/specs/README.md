...
- [01 - Idempotência de mensagens](docs/specs/planned/01-idempotencia-de-mensagens.md)
- [04 - Consolidação do modelo de mensagem entre HTTP e worker](docs/specs/planned/04-consolidacao-modelo-de-mensagem.md)
- [05 - Processamento real de mensagens no ChatProcessorService](docs/specs/planned/05-processamento-real-chat-worker.md)
- [06 - Endpoint de recuperação de acesso](docs/specs/planned/06-endpoint-auth-recover.md)
- [07 - Endpoint HTTP para bootstrap da fila](docs/specs/planned/07-endpoint-http-fila-bootstrap.md)
- [08 - Domínio de pontos, repositório e regras por plataforma](docs/specs/planned/08-dominio-pontos-repositorio-e-regras.md)
- [09 - Use case de pontuação e evento points_updated](docs/specs/planned/09-award-points-e-evento-points-updated.md)
- [10 - Comandos iniciais e registro no dispatcher](docs/specs/planned/10-comandos-iniciais-e-dispatcher.md)
- [11 - Segurança básica do ingest por token em header](docs/specs/planned/11-seguranca-basica-ingest-token-header.md)
